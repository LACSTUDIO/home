...
// Umami API 配置
const API_BASE_URL = 'https://umami.xn--5brr03o.top/api/auth/login'; // 替换为你的 Umami API 地址
const WEBSITE_ID = '9d107a47-e0d9-4c91-a113-dd69c3983b48'; // 替换为你的网站 ID
const TOKEN = ''; // 替换为你的 API Token

// 获取统计数据
async function fetchUmamiData() {
    try {
        const response = await fetch(`${API_BASE_URL}/websites/${WEBSITE_ID}/stats`, {
            headers: {
...
async function updateStats() {
    const data = await fetchUmamiData();
    if (data) {
